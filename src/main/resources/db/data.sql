...
INSERT INTO Orcamento (idPedido, custoPedido, custoImposto, desconto, totalPagar, efetivado, data) VALUES (1, 3000.0, 300.0, 50.0, 3250.0, true, '2023-01-03');
INSERT INTO Orcamento (idPedido, custoPedido, custoImposto, desconto, totalPagar, efetivado, data) VALUES (2, 4000.0, 400.0, 100.0, 4300.0, true, '2023-01-04');

-- Inserting `ItemPedido` records for `Orcamento` with ID 1
...
-- Inserting `ItemPedido` records for `Orcamento` with ID 2
