...
INSERT INTO orcamento (ID, NOME_CLIENTE, CUSTO_PEDIDO, CUSTO_IMPOSTO, DESCONTO, TOTAL_PAGAR, EFETIVADO, DATA) VALUES (1, 'Fulano', 3000.0, 300.0, 0.0, 3250.0, true, '2023-01-03');
INSERT INTO orcamento (ID, NOME_CLIENTE, CUSTO_PEDIDO, CUSTO_IMPOSTO, DESCONTO, TOTAL_PAGAR, EFETIVADO, DATA) VALUES (2, 'Beltrano', 4000.0, 400.0, 0.0, 4300.0, true, '2023-01-04');
